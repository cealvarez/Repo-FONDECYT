...
Para usar las funciones que aparecen en Main.py, basta con descomentar la función
ShowImplicitDerivation: Grafo de derivación implícita
ShowDuo: Grafo de duplas
ShowExplicitDerivation: Grafo de derivación explícita
